...
public class MvcConfiguration implements WebMvcConfigurer {
    ...
    public void addViewControllers(ViewControllerRegistry registry) {
        ...
        registry.addViewController("/update_reservation").setViewName("update_reservation");
        ...
        registry.addViewController("/create_menu").setViewName("create_menu");
        registry.addViewController("/update_menu").setViewName("update_menu");
        ...
        registry.addViewController("/get_payment").setViewName("get_payment");
    }
}
