...
public class DrinkRepositoryImpl implements DrinkRepository {
    private List<Drink> drinkList = Arrays.asList(
            new Drink(1, "CocoCola", "Soft", 200, 1.5),
            new Drink(2, "Pepsi", "Soft", 200, 1),
            new Drink(3, "Corona", "Beer", 200, 3),
            new Drink(4, "Chivas", "Whiskey", 200, 10),
            new Drink(5, "Spa", "Soft", 200, 1),
            new Drink(6, "Dujardin Blauw", "Brandy", 200, 20),
            new Drink(7, "Heneiken", "Beer", 200, 3),
            new Drink(8, "LeCola", "Soft", 200, 1),
            new Drink(9, "Guiness", "Beer", 200, 3)
